...
namespace CSBGlobal.Helpers
{
    public class OrderCompletedHelper
    {
        ...
        public string SendCustomerCreatedMail(ApplicationUser applicationUser, CustomersResponseModel createCustomerCsp)
        {
            ...
            string response = _emailservice.SendPlainEmailAsync(applicationUser.Email, mailSubject, mailBody.ToString());
            return response;
        }
        public string SendServiceProvisionedMail(ApplicationUser applicationUser)
        {
            ...
            var msg = _emailservice.SendPlainEmailAsync(applicationUser.Email, "Order Created", mailmsg.ToString());
            return msg;
        }

        public CustomersModel BuildCustomerModel(ApplicationUser CSPUser, string domain)
        {
            ...
            {
                FirstName = CSPUser.FirstName,
                LastName = CSPUser.LastName,
                AddressLine1 = CSPUser.CompanyAddress,
                City = CSPUser.City,
                State = CSPUser.State,
                Country = CSPUser.Country,
                PostalCode = CSPUser.PostCode,
                PhoneNumber = CSPUser.PhoneNumber
