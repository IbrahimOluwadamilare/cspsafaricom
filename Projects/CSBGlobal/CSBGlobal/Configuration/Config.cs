...
namespace CSBGlobal.Configuration
{
    public static class Config
    {
        ...
        internal static string Domainsuffix = ".onmicrosoft.com";
        ...
        internal static string OrderLink = "https://www.smeproductivity.com/CustomerDashboard/OrderDetails";
