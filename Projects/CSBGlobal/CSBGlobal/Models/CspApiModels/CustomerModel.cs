namespace CSBGlobal.Models.CspApiModels
{
    ...
    public partial class CustomersModel
    {
        public static CustomersModel FromJson(string json) => JsonConvert.DeserializeObject<CustomersModel>(json, CSBGlobal.Models.CspApiModels.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this CustomersModel self) => JsonConvert.SerializeObject(self, CSBGlobal.Models.CspApiModels.Converter.Settings);
    }
